  ...
  "use strict";
    ...
    jQuery(document).ready(function(){
        ...
        */
        ...
        --------------------------------------------------------- */
        $('.ltn__slide-active-2').not('.slick-initialized').slick({
            autoplay: false,
            autoplaySpeed: 2000,
            arrows: false,
            dots: true,
        ...
        --------------------------------------------------------- */
        $('.ltn__product-slider-one-active').not('.slick-initialized').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        /* --------------------------------------------------------
            16-1. Product Slider One
        --------------------------------------------------------- */
        $('.ltn__product-slider-item-three-active').not('.slick-initialized').slick({
            arrows: true,
            dots: true,
            infinite: true,
            speed: 300,
        ...
        --------------------------------------------------------- */
        $('.ltn__product-slider-item-four-active').not('.slick-initialized').slick({
            arrows: true,
            dots: true,
            infinite: true,
            speed: 300,
        ...
        --------------------------------------------------------- */
        $('.ltn__related-product-slider-two-active').not('.slick-initialized').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        /* --------------------------------------------------------
            ## Related Product Slider One
        --------------------------------------------------------- */
        $('.ltn__popular-product-widget-active').not('.slick-initialized').slick({
            arrows: false,
            dots: true,
            infinite: true,
            speed: 300,
        ...
        --------------------------------------------------------- */
        $('.ltn__small-product-slider-active').not('.slick-initialized').slick({
            arrows: false,
            dots: true,
            infinite: true,
            speed: 300,
        ...
        /* --------------------------------------------------------
            19. Testimonial Slider - 1
        --------------------------------------------------------- */
        $('.ltn__testimonial-slider-active').not('.slick-initialized').slick({
            arrows: true,
            dots: true,
            infinite: true,
            speed: 300,
        ...
        /* --------------------------------------------------------
            22. Category Slider
        --------------------------------------------------------- */
        $('.ltn__category-slider-active').not('.slick-initialized').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        /* --------------------------------------------------------
            23. Image Slide  - 1 (Screenshot)
        --------------------------------------------------------- */
        $('.ltn__image-slider-1-active').not('.slick-initialized').slick({
            arrows: true,
            dots: false,
            infinite: true,
            speed: 300,
        ...
        /* --------------------------------------------------------
            24. Image Slide - 2
        --------------------------------------------------------- */
        $('.ltn__image-slider-2-active').not('.slick-initialized').slick({
            rtl: false,
            arrows: true,
            dots: false,
            infinite: true,
        ...
        /* --------------------------------------------------------
            25. Image Slide - 3
        --------------------------------------------------------- */
        $('.ltn__image-slider-3-active').not('.slick-initialized').slick({
            rtl: false,
            arrows: true,
            dots: false,
            infinite: true,
        ...
        if($('.ltn__blog-gallery-active').length){
            $('.ltn__blog-gallery-active').not('.slick-initialized').slick({
                rtl: false,
                arrows: true,
                dots: false,
                infinite: true,
        ...
        if($('.ltn__instafeed').length){
            ...
            $('.ltn__instafeed').on("DOMNodeInserted", function (e) {
                if (e.target.className == 'instagram_gallery') {
                    $('.ltn__instafeed-slider-2 .' + e.target.className).not('.slick-initialized').slick({
                        infinite: true,
                        slidesToShow: 3,
                        slidesToScroll: 1,
                        prevArrow: '<a class="slick-prev"><i class="fas fa-arrow-left" alt="Arrow Icon"></i></a>',
                    ...
                    $('.ltn__instafeed-slider-1 .' + e.target.className).not('.slick-initialized').slick({
                        infinite: true,
                        slidesToShow: 5,
                        slidesToScroll: 1,
                        prevArrow: '<a class="slick-prev"><i class="fas fa-arrow-left" alt="Arrow Icon"></i></a>',
        ...
        */
        ...
        ltn__testimonial_quote_slider.not('.slick-initialized').slick({
            autoplay: true,
            autoplaySpeed: 3000,
            dots: false,
            arrows: true,
        ...
        $(document).on('click', '.ltn__testimonial-quote-menu li', function (e) {
            ...
            ltn__testimonial_quote_slider.not('.slick-initialized').slick('slickGoTo', elIndex);
